...
export default function AdminPageClientComponent() {
  ...
  // State for desktop view filter selection
  ...
  const ClinicDetailsModal = () => {
    ...
    // Determine the status of the selected clinic
    const clinicStatus = pendingClinics.some(
      (clinic) => clinic.userId === selectedClinicId
    )
      ? "pending"
      : approvedClinics.some((clinic) => clinic.userId === selectedClinicId)
        ? "approved"
        : "rejected";
            ...
            <div className="flex justify-end space-x-3 mt-6">
              {clinicStatus === "pending" && (
                <>
                  <Button
                    onClick={() =>
                      handleStatusUpdate(selectedClinicId, "approved")
                    }
                  ...
                  <Button
                    onClick={() =>
                      handleStatusUpdate(selectedClinicId, "rejected")
                    }
                    variant="destructive"
                  >
                    Reject Clinic
              ...
              {clinicStatus === "rejected" && (
                <>
                  <Button
                    onClick={() =>
                      handleStatusUpdate(selectedClinicId, "pending")
                    }
                    variant="outline"
                  >
                    Restore Clinic
                  ...
                  <Button
                    onClick={() => handleDelete(selectedClinicId)}
                    variant="destructive"
                  >
                    Delete Permanently
                  </Button>
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        {/* Mobile view: Conditional rendering based on selected tab */}
        ...
        {/* Desktop view: Conditional rendering based on filter */}
        <div className="hidden md:block">
          {(desktopFilter === "all" || desktopFilter === "pending") && (
            <div className="bg-white rounded-lg shadow mb-8">
              <div className="px-6 py-4 border-b border-gray-200">
                <div className="flex items-center justify-between">
                  <h2 className="text-lg font-medium text-gray-900">
          ...
          {(desktopFilter === "all" || desktopFilter === "approved") && (
            <div className="bg-white rounded-lg shadow mb-8">
              <div className="px-6 py-4 border-b border-gray-200">
                <div className="flex items-center justify-between">
                  <h2 className="text-lg font-medium text-gray-900">
          ...
          {(desktopFilter === "all" || desktopFilter === "rejected") && (
            <div className="bg-white rounded-lg shadow">
              <div className="px-6 py-4 border-b border-gray-200">
                <div className="flex items-center justify-between">
                  <h2 className="text-lg font-medium text-gray-900">
